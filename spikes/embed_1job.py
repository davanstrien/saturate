"""Embeddings at scale — ONE job, 200k fineweb-edu texts through vLLM pooling.
...
def main() -> None:
    ...
    print(f"EMBED_SCALE texts_per_sec={texts_s} " + stats.to_json(), flush=True)
